    ...
    */
    ...
    public static void main(String[] args)  throws IOException  {
        ...
        try {
            ...
            try(PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("test-data-male"+".txt", true)))) {
        ...
        try {
            /* args[2] is the Class of the image, Class = Male/Female. Vector will be written into a text file */
            try(PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("test-data-female"+".txt", true)))) {
